  ...
  return (
    <div>
      <Header />
        ...
        <div className='border-t-3 border-gray-300 w-[80%] md:w-[90%] mx-auto mb-13'></div>
        ...
        <div className='flex flex-col md:flex-row w-full text-center items-center p-10'>
            ...
            <div className='flex flex-col md:w-[50%] justify-center items-center md:items-start md:pr-5'>
                ...
                <div className='border-b-3 border-[#10783B] justify-center w-[80%] md:w-full mb-5 md:mr-auto'></div>
